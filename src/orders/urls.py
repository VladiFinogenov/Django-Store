...
from .views import (OrderDetail, Step1UserData, Step2SelectDelivery,
                    Step3SelectPayment, Step4OrderConfirmation)
...
urlpatterns = [
    ...
    path("oneoeder/<int:pk>/", OrderDetail.as_view(), name='order_detail'),
]
